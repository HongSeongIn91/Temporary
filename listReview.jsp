...
<body>
	<div id="wrapper">
		...
		<table border="1">
			<tr>
				<td colspan="6"><a href="reviewwrite.do?no=1">[게시글 쓰기]</a></td>
			</tr>
			<tr>
				<td>게시글목록번호</td>
				<td>리뷰글번호</td>
			...
			<c:forEach var="review" items="${reviewPage.content }">
				<tr>
					...
					<td><a
						href="reviewread.do?rv_num=${review.rv_num }&pageNo=${reviewPage.currentPage}<%-- &mno=${article.rv_mv_num} --%>">
			...
			<tr>
				<td colspan="8" align="center"><br />
					<form action="reviewsearch.do" method="get" name="search">
						...
						</select> <input type="text" name="keyWord" value="${param.keyWord}" /> <input
							type="button" value="검색" onclick="searchCheck(form)" />
