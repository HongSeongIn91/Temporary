...
<form action="searchId.do" name="search" method="post" onsubmit="sub()">
...
<p>
	<input type="text" name="birth" placeholder="예시) 19970505" size="16" maxlength="8"/>								
...
<p>
	이메일:<input type="hidden" name="email" />
	
			<input type="text" name="email1" id="str_email01" size="16" maxlength="20" />
			<span>@</span>
			<input type="text" name="email2" id="str_email02" disabled value="gmail.com" size="10" />
