	...
	<div id="wrapper">
				...
				<table>
					...
					<tr>
						...
						<td><input type="text" name="m_id"
							placeholder="영문+숫자 최대 16자리" size="16" maxlength="16"
							value="${param.m_id}"> <c:if test="${errors.m_id}"> ID를 입력하세요.</c:if>
					...
					<tr>
						...
						<td><input type="password" name="m_pw"
							placeholder="영문+숫자 최대 16자리" size="16" maxlength="16"> <c:if
								test="${errors.m_pw}"> 비밀번호를 입력하세요.</c:if></td>
					</tr>
					...
					<tr>
						...
						<td><input type="password" name="confirmPassword"
							placeholder="영문+숫자 최대 16자리" size="16" maxlength="16"> <c:if
								test="${errors.confrimPassword}"> 비밀번호를 한번 더 입력하세요.</c:if> <c:if
								test="${errors.notMatch}"> 비밀번호가 일치하지 않습니다.</c:if></td>
					</tr>
		...
		<input type="text" name="m_birth" placeholder="예시) 19970505" size="16" maxlength="8" value="${param.m_birth}"/>								
				...
				<c:if test="${errors.m_birth}"> 생년월일8자리 입력하세요.</c:if>						
					...
					<tr>
						<th>생년월일2</th>
						<td><input type="hidden" name="m_birth"
							value="${param.m_birth}" /> <input type="text" name="m_birth1"
							placeholder="예) 1997년생 > 1997" size="16" maxlength="4" /> <select
							name="m_birth2">
					...
					<tr>
						...
						<td><label>남성<input type="radio" name="m_gender"
								value="male" /></label> <label>여성<input type="radio"
								name="m_gender" value="female" />
						</label></td>
					</tr>
					...
					<tr>
						...
						<td><input type="hidden" name="m_email"
							value="${param.m_email}" /> <input type="text" name="m_email1"
							id="str_email01" size="16" maxlength="20" /> <span>@</span> <input
							...
							id="selectEmail">
								...
								</script> <c:if test="${errors.m_email}"> 이메일 입력하세요.</c:if></td>
					</tr>

					<tr>
						<th>핸드폰 번호</th>
						<td><input type="hidden" name="m_phone"
						...
						</select> - <input type="text" name="m_phone2" size="1" maxlength="4" />
