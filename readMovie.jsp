		...
		<c:forEach var="preview" items="${prePage.content}">
			<tr>
				...
				<c:if test="${authUser.id == preview.pre_m_id }">
					<td>
						<div>
							<a href="modifyPreview.do?pre_num=${preview.pre_num}&mv_num=${movieData.movie.mv_num}&prePageNo=${prePage.currentPage}">
								<input type="button" value="수정">
							</a>
							<p>
							<a href="deletePreview.do?pre_num=${preview.pre_num}&mv_num=${movieData.movie.mv_num}&prePageNo=${prePage.currentPage}">
